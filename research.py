...
user_proxy.initiate_chat(
    manager,
    message="""
Find papers on 'Large Language Model' applications from arxiv in the last week, create a markdown table of different domains and the title of those papers and store it.
""",
)